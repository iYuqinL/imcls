...
def resnest50_fast_1s1x64d(pretrained=False, root='~/.encoding/models', **kwargs):
    model = _resnest('resnest50_fast_1s1x64d', Bottleneck, [3, 4, 6, 3], pretrained,
                     radix=1, groups=1, bottleneck_width=64, deep_stem=True, stem_width=32,
                     avg_down=True, avd=True, avd_first=True, **kwargs)
    return model


def resnest50_fast_2s1x64d(pretrained=False, root='~/.encoding/models', **kwargs):
    model = _resnest('resnest50_fast_2s1x64d', Bottleneck, [3, 4, 6, 3], pretrained,
...
def resnest50_fast_4s1x64d(pretrained=False, root='~/.encoding/models', **kwargs):
    model = _resnest('resnest50_fast_4s1x64d', Bottleneck, [3, 4, 6, 3], pretrained,
                     radix=4, groups=1, bottleneck_width=64, deep_stem=True, stem_width=32,
                     avg_down=True, avd=True, avd_first=True, **kwargs)
    return model


def resnest50_fast_1s2x40d(pretrained=False, root='~/.encoding/models', **kwargs):
    model = _resnest('resnest50_fast_1s2x40d', Bottleneck, [3, 4, 6, 3], pretrained,
                     radix=1, groups=2, bottleneck_width=40, deep_stem=True, stem_width=32,
                     avg_down=True, avd=True, avd_first=True, **kwargs)
...
def resnest50_fast_2s2x40d(pretrained=False, root='~/.encoding/models', **kwargs):
    model = _resnest('resnest50_fast_2s2x40d', Bottleneck, [3, 4, 6, 3], pretrained,
                     radix=2, groups=2, bottleneck_width=40, deep_stem=True, stem_width=32,
                     avg_down=True, avd=True, avd_first=True, **kwargs)
    return model


def resnest50_fast_4s2x40d(pretrained=False, root='~/.encoding/models', **kwargs):
    model = _resnest('resnest50_fast_4s2x40d', Bottleneck, [3, 4, 6, 3], pretrained,
                     radix=4, groups=2, bottleneck_width=40, deep_stem=True, stem_width=32,
                     avg_down=True, avd=True, avd_first=True, **kwargs)
...
def resnest50_fast_1s4x24d(pretrained=False, root='~/.encoding/models', **kwargs):
    model = _resnest('resnest50_fast_1s4x24d', Bottleneck, [3, 4, 6, 3], pretrained,
                     radix=1, groups=4, bottleneck_width=24, deep_stem=True, stem_width=32,
                     avg_down=True, avd=True, avd_first=True, **kwargs)
