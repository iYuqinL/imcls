...
# model_urls = {
#     'resnet18': 'resnet_cbam/pretrained_model/resnet18-5c106cde.pth',
#     'resnet34': 'resnet_cbam/pretrained_model/resnet34-333f7ec4.pth',
...
def _resnet(arch, block, layers, pretrained, progress, **kwargs):
    ...
    if pretrained:
        ...
        assert (str(res.missing_keys) ==
                str(['ca.fc1.weight', 'ca.fc2.weight', 'sa.conv1.weight'])), 'issue loading pretrained weights, fc'
    return model
