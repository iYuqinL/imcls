...
if __name__ == "__main__":
    ...
    result_csv = "../test_results/test-out-en-10-b7-seq-vb-ls.csv"
    submit_csv = "/home/yusnows/Documents/DataSets/competition/weatherRecog/submits/csv/submit-en-10-b7-seq-vb-ls.csv"
