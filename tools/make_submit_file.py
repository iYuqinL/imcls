...
if __name__ == "__main__":
    ...
    # test_results/test-f10-1-b4-vb-bs-uni-aug.csv
    result_csv = "../test_results/test-f10-0-b4-vb-bs-uni-aug.csv"
    submit_csv = "/home/yusnows/Documents/DataSets/competition/weatherRecog/submits/csv/submit-f10-0-b4-seq-tb-bs-uni-aug-1003.csv"
